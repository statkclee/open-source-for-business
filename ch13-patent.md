...
*특허권 청구(patent claim)*는 특허가 보장하는 발명을 기술하는 특허 부분이다. *필요 청구(necessary claim)*는 특허권 청구로 이것이 없이 예를 들어, 표준을 실행하거나 소프트웨어 일부 조각을 사용하는 활동에 관여하는 것이 가능하거나 혹은 아마도 실현가능하지 못할 것이다. 
