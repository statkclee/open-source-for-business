...
*오픈*에 대한 단일 정의는 존재하지 않는다. 많은 것이 오픈이라고 주장한다. 하지만, 전반적으로 오픈 패러다임은 외부 당사자를 제외하기 보다는 외부 당사자를 참여시키고자 한다. 오픈 모형은 또한 투명성과 지위보다는 능력에 기반한 참여에 초점을 두는 특징을 갖고 있다. 자유든 무료든 지적재산권에 대한 라이선싱은 방정식의 일부분이다.
